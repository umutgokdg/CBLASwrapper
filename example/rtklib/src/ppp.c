...
/* measurement error variance for TC EKF (CNSS eklentisi)  ------------------------------------------------*/
...
extern void pppos(rtk_t *rtk, const obsd_t *obs, int n, const nav_t *nav)
{
    ...
    satposs(obs[0].time,obs,n,nav,rtk->opt.sateph,rs,dts,var,svh, opt->navtype_t);
